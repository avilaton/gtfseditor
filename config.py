...
class Config:
    ...
    MAIL_USE_SSL = True 
    MAIL_USE_TLS = False
    MAIL_USERNAME = 'gtfseditor@gmail.com'
    MAIL_PASSWORD = 'gtfseditor1234'
    FLASKY_MAIL_SUBJECT_PREFIX = '[Prueba]'
    FLASKY_MAIL_SENDER = 'Prueba Gtfseditor <gtfseditor@gmail.com>'
