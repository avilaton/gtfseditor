...
if __name__ == '__main__':
	# readers
	paradas = readParadas('asf/paradas.csv')
	trip_stops = readParadasPorRecorrido('asf/paradas_por_recorrido.csv')

	kml = Kml('asf/paradas.kml')
	kml.findPlacemarks()
	rows = []
	...
	with open('asf/stops.txt', 'wb') as csvfile:
		writer = csv.DictWriter(csvfile, fields)
		writer.writeheader()
		writer.writerows(rows)

	with open('asf/stop_times.txt', 'wb') as csvfile:
